      ...
      <main className="flex-time font-pizza m-auto max-w-sm md:max-w-3xl lg:max-w-7xl p-8 rounded-2xl bg-neutral-100 ">
        ...
        <section className="mr-auto text-xl">
          ...
          {finishedTask.map((task, index) => (
            <li key={index}>{task.completed}</li>
          ))}
        </section>
