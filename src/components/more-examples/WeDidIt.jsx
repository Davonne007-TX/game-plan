export default function WeDidIt() {
  ...
  return (
    <section className="flex-time font-bold font-pizza">
      <h1 className="text-pink-500 text-5xl mb-10">
        We did it <br />
        <p className="text-xl">Have to Setup Everything</p>
      </h1>

      {setUpEverything.map((everything, id) => (
        <li key={id} className="text-white text-3xl list-none">
      ...
      ></iframe>
      <p>
        <a href="https://giphy.com/gifs/dora-en-boots-l0IsIC9ZNOELYmuqc">
          via GIPHY
        </a>
      </p>
    </section>
